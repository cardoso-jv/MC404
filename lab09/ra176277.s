...
@ robo deve mudar a rota ou seguir em frente.
...
min:
        ...
        blt mudaRota            @ Se r0 menor que o limiar: Salta para mudaRota
...
mudaRota:                       @ Gira para Esquerda
        mov r0, #36             @ Define velocidade do motor 0
        mov r1, #0              @ Define velocidade do motor 1
        mov r7, #124            @ Identifica a syscall 124 (write_motors)
        svc 0x0                 @ Faz a chamada da syscall
